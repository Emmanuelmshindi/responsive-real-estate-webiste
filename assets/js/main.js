...
// Get the theme that was previously selected by user
...
//If it has the dark theme class it is in dark but if not it is in light
//If the theme button has the iconTheme class it has the moon icon, if not it has the sun icon

// Validate if the user previously chose a theme
if (selectedTheme) {
    // If validation is fulfilled, we check if we activated or deactivated dark theme
